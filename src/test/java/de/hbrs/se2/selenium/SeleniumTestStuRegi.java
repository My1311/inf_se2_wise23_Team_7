...
public class SeleniumTestStuRegi {
    @Ignore
    @Test
    public void StuRegi(){
        ...
        WebElement student=driver.findElement(By.id("input-vaadin-radio-button-44"));
        ...
        student.click();
        login.click();
        String sollte = "http://localhost:8080/register/student";
